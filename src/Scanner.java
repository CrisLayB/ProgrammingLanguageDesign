...
public class Scanner {
	...
	private static NFA megaAutomata() { 
		...
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("110", Types.Initial)));
		transitions.add(new Transition(new Symbol("42"), new State("112", Types.Initial), new State("113", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("112", Types.Initial)));
		...
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("116", Types.Initial)));
