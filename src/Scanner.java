...
public class Scanner {
	...
	private static NFA megaAutomata() { 
		...
		transitions.add(new Transition(new Symbol("59", "59"), new State("398", Types.Initial), new State("399", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("398", Types.Initial)));
		transitions.add(new Transition(new Symbol(":=", ":="), new State("400", Types.Initial), new State("401", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("400", Types.Initial)));
		transitions.add(new Transition(new Symbol("60", "60"), new State("402", Types.Initial), new State("403", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("402", Types.Initial)));
		transitions.add(new Transition(new Symbol("61", "61"), new State("404", Types.Initial), new State("405", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("404", Types.Initial)));
		transitions.add(new Transition(new Symbol("43", "43"), new State("406", Types.Initial), new State("407", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("406", Types.Initial)));
		transitions.add(new Transition(new Symbol("45", "45"), new State("408", Types.Initial), new State("409", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("408", Types.Initial)));
		transitions.add(new Transition(new Symbol("42", "42"), new State("410", Types.Initial), new State("411", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("410", Types.Initial)));
		transitions.add(new Transition(new Symbol("47", "47"), new State("412", Types.Initial), new State("413", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("412", Types.Initial)));
		transitions.add(new Transition(new Symbol("40", "40"), new State("414", Types.Initial), new State("415", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("414", Types.Initial)));
		transitions.add(new Transition(new Symbol("41", "41"), new State("416", Types.Initial), new State("417", Types.Final)));
