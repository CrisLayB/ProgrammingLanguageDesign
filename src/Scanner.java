...
public class Scanner {
	...
	private static NFA megaAutomata() { 
		...
		finalStates.add(new State("119", Types.Final));
		...
		finalStates.add(new State("425", Types.Final));
		finalStates.add(new State("429", Types.Final));
		finalStates.add(new State("433", Types.Final));
		finalStates.add(new State("437", Types.Final));
		finalStates.add(new State("441", Types.Final));
		finalStates.add(new State("445", Types.Final));
		List<State> states = new ArrayList<State>();
		states.add(new State("25", Types.Final));
		states.add(new State("119", Types.Final));
		...
		states.add(new State("425", Types.Final));
		states.add(new State("429", Types.Final));
		states.add(new State("433", Types.Final));
		states.add(new State("437", Types.Final));
		states.add(new State("441", Types.Final));
		states.add(new State("445", Types.Final));
		...
		transitions.add(new Transition(new Symbol("95", "id"), new State("70", Types.Transition), new State("71", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("71", Types.Transition), new State("70", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("72", Types.Transition), new State("73", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("€"), new State("74", Types.Transition), new State("68", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("74", Types.Transition), new State("72", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("69", Types.Transition), new State("75", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("73", Types.Transition), new State("75", Types.Transition)));
		transitions.add(new Transition(new Symbol("48", "id"), new State("76", Types.Transition), new State("77", Types.Transition)));
		transitions.add(new Transition(new Symbol("49", "id"), new State("78", Types.Transition), new State("79", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("50", "id"), new State("82", Types.Transition), new State("83", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("51", "id"), new State("86", Types.Transition), new State("87", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("52", "id"), new State("90", Types.Transition), new State("91", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("53", "id"), new State("94", Types.Transition), new State("95", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("54", "id"), new State("98", Types.Transition), new State("99", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("55", "id"), new State("102", Types.Transition), new State("103", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("56", "id"), new State("106", Types.Transition), new State("107", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("57", "id"), new State("110", Types.Transition), new State("111", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("€"), new State("114", Types.Transition), new State("74", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("114", Types.Transition), new State("112", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("75", Types.Transition), new State("115", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("113", Types.Transition), new State("115", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("115", Types.Transition), new State("114", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("116", Types.Transition), new State("117", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("€"), new State("47", Types.Transition), new State("116", Types.Transition)));
		transitions.add(new Transition(new Symbol("#id", "id"), new State("118", Types.Transition), new State("119", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("117", Types.Transition), new State("118", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("46", Types.Initial)));
		transitions.add(new Transition(new Symbol(".", "number"), new State("304", Types.Initial), new State("305", Types.Transition)));
		transitions.add(new Transition(new Symbol("69", "number"), new State("306", Types.Transition), new State("307", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("308", Types.Transition), new State("309", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("48", "number"), new State("312", Types.Transition), new State("313", Types.Transition)));
		transitions.add(new Transition(new Symbol("49", "number"), new State("314", Types.Transition), new State("315", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("50", "number"), new State("318", Types.Transition), new State("319", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("51", "number"), new State("322", Types.Transition), new State("323", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("52", "number"), new State("326", Types.Transition), new State("327", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("53", "number"), new State("330", Types.Transition), new State("331", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("54", "number"), new State("334", Types.Transition), new State("335", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("55", "number"), new State("338", Types.Transition), new State("339", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("56", "number"), new State("342", Types.Transition), new State("343", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("57", "number"), new State("346", Types.Transition), new State("347", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("48"), new State("350", Types.Transition), new State("351", Types.Transition)));
		transitions.add(new Transition(new Symbol("49"), new State("352", Types.Transition), new State("353", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("50"), new State("356", Types.Transition), new State("357", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("51"), new State("360", Types.Transition), new State("361", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("52"), new State("364", Types.Transition), new State("365", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("53"), new State("368", Types.Transition), new State("369", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("54"), new State("372", Types.Transition), new State("373", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("55"), new State("376", Types.Transition), new State("377", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("56"), new State("380", Types.Transition), new State("381", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("57"), new State("384", Types.Transition), new State("385", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("€"), new State("387", Types.Transition), new State("386", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("396", Types.Transition), new State("397", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("396", Types.Transition), new State("386", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("387", Types.Transition), new State("397", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("349", Types.Transition), new State("396", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("311", Types.Transition), new State("348", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("398", Types.Transition), new State("399", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("400", Types.Transition), new State("310", Types.Transition)));
		...
		transitions.add(new Transition(new Symbol("€"), new State("305", Types.Transition), new State("400", Types.Transition)));
		transitions.add(new Transition(new Symbol("#number", "number"), new State("402", Types.Transition), new State("403", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("401", Types.Transition), new State("402", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("304", Types.Initial)));
		transitions.add(new Transition(new Symbol("59", ";"), new State("404", Types.Initial), new State("405", Types.Transition)));
		transitions.add(new Transition(new Symbol("#;", ";"), new State("406", Types.Transition), new State("407", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("405", Types.Transition), new State("406", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("404", Types.Initial)));
		transitions.add(new Transition(new Symbol("58", ":="), new State("408", Types.Initial), new State("409", Types.Transition)));
		transitions.add(new Transition(new Symbol("61", ":="), new State("410", Types.Transition), new State("411", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("409", Types.Transition), new State("410", Types.Transition)));
		transitions.add(new Transition(new Symbol("#:=", ":="), new State("412", Types.Transition), new State("413", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("411", Types.Transition), new State("412", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("408", Types.Initial)));
		transitions.add(new Transition(new Symbol("60", "<"), new State("414", Types.Initial), new State("415", Types.Transition)));
		transitions.add(new Transition(new Symbol("#<", "<"), new State("416", Types.Transition), new State("417", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("415", Types.Transition), new State("416", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("414", Types.Initial)));
		transitions.add(new Transition(new Symbol("61", "="), new State("418", Types.Initial), new State("419", Types.Transition)));
		transitions.add(new Transition(new Symbol("#=", "="), new State("420", Types.Transition), new State("421", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("419", Types.Transition), new State("420", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("418", Types.Initial)));
		transitions.add(new Transition(new Symbol("43", "+"), new State("422", Types.Initial), new State("423", Types.Transition)));
		transitions.add(new Transition(new Symbol("#+", "+"), new State("424", Types.Transition), new State("425", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("423", Types.Transition), new State("424", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("422", Types.Initial)));
		transitions.add(new Transition(new Symbol("45", "-"), new State("426", Types.Initial), new State("427", Types.Transition)));
		transitions.add(new Transition(new Symbol("#-", "-"), new State("428", Types.Transition), new State("429", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("427", Types.Transition), new State("428", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("426", Types.Initial)));
		transitions.add(new Transition(new Symbol("42", "*"), new State("430", Types.Initial), new State("431", Types.Transition)));
		transitions.add(new Transition(new Symbol("#*", "*"), new State("432", Types.Transition), new State("433", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("431", Types.Transition), new State("432", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("430", Types.Initial)));
		transitions.add(new Transition(new Symbol("47", "/"), new State("434", Types.Initial), new State("435", Types.Transition)));
		transitions.add(new Transition(new Symbol("#/", "/"), new State("436", Types.Transition), new State("437", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("435", Types.Transition), new State("436", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("434", Types.Initial)));
		transitions.add(new Transition(new Symbol("40", "("), new State("438", Types.Initial), new State("439", Types.Transition)));
		transitions.add(new Transition(new Symbol("#(", "("), new State("440", Types.Transition), new State("441", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("439", Types.Transition), new State("440", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("438", Types.Initial)));
		transitions.add(new Transition(new Symbol("41", ")"), new State("442", Types.Initial), new State("443", Types.Transition)));
		transitions.add(new Transition(new Symbol("#)", ")"), new State("444", Types.Transition), new State("445", Types.Final)));
		transitions.add(new Transition(new Symbol("€"), new State("443", Types.Transition), new State("444", Types.Transition)));
		transitions.add(new Transition(new Symbol("€"), new State("0", Types.Initial), new State("442", Types.Initial)));
